...
// testing
    ...
    public void onEnable() {
        ItemStack categoryItem = new CustomItem(Material.OBSIDIAN, "&8Armadura de obsidiana", "", "&a> Haz clic para abrir");

        NamespacedKey categoryId = new NamespacedKey(this, "OBSIDIAN_ARMOR");
        Category category = new Category(categoryId, categoryItem);
        
        
        SlimefunItemStack obs_alloy = new SlimefunItemStack("OBSIDIAN_ALLOY", Material.DIAMOND, "&8Aleación de obsidiana", "&7Material para fabricar equipo de obsidiana.");
        ...
        SlimefunItemStack obsHelmet = new SlimefunItemStack("OBSIDIAN_HELMET", Material.DIAMOND_HELMET, "&8Yelmo de obsidiana", "&7Forjado con una resistente aleación de obsidiana." );
        ...
        isHelmet.addUnsafeEnchantment(Enchantment.BLAST_PROTECTION, 6);
        isHelmet.addUnsafeEnchantment(Enchantment.PROTECTION, 4);
       
        obs_helmet.register(this);

        SlimefunItemStack obsChestplate = new SlimefunItemStack("OBSIDIAN_CHESTPLATE", Material.DIAMOND_CHESTPLATE, "&8Coraza de obsidiana", "&7Forjada con una resistente aleación de obsidiana." );
        ...
        is.addUnsafeEnchantment(Enchantment.BLAST_PROTECTION, 6);
        ...
        SlimefunItemStack obsLeggings = new SlimefunItemStack("OBSIDIAN_LEGGINGS", Material.DIAMOND_LEGGINGS, "&8Grebas de obsidiana", "&7Forjadas con una resistente aleación de obsidiana." );
        ...
        isLeggings.addUnsafeEnchantment(Enchantment.BLAST_PROTECTION, 6);
        isLeggings.addUnsafeEnchantment(Enchantment.PROTECTION, 4);
       
        obs_leggings.register(this);
        
        
        SlimefunItemStack obsBoots = new SlimefunItemStack("OBSIDIAN_BOOTS", Material.DIAMOND_BOOTS, "&8Botas de obsidiana", "&7Forjadas con una resistente aleación de obsidiana." );
        ...
        isBoots.addUnsafeEnchantment(Enchantment.BLAST_PROTECTION, 6);
